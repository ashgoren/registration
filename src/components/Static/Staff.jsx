    ...
    <StyledPaper extraStyles={{ maxWidth: 750 }}>
      ...
      <Box>
        ...
        <Box sx={{ mt: 2, pr: 4, float: { xs: 'none', sm: 'left' } }}>
          <img src={'/some_event/SethTepfer.jpg'} alt="Seth Tepfer" />
        </Box>
      ...
      <Box sx={{ mt: 6 }}>
        ...
        <Box sx={{ mt: 2, pl: { xs: 'none', sm: 4 }, float: { xs: 'none', sm: 'right' } }}>
          <img src={'/some_event/WillMentor.jpg'} alt="Will Mentor" />
        </Box>
        <Paragraph sx={{ pt: 1, mb: 0 }}>
      ...
      <Box>
        <Box sx={{ mt: 2, pl: { xs: 'none', sm: 4 }, float: { xs: 'none', sm: 'right' } }}>
          <img src={'/some_event/notorious.jpeg'} alt="Notorious"  style={{ width: 300 }} />
        </Box>
        <Paragraph sx={{ pt: 1, mb: 0 }}>
      ...
      <Box>
        <Box sx={{ mt: 2, pr: { xs: 'none', sm: 4 }, float: { xs: 'none', sm: 'left' } }}>
          <img src={'/some_event/playing-with-fyre.png'} alt="Playing with Fyre"  style={{ width: 300 }} />
        </Box>
        <Paragraph sx={{ pt: 1, mb: 0 }}>
